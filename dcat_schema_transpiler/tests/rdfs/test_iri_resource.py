...
def test_iri_resource_factory():
    ...
    dog_neocortex = iri_resource_factory(Neocortex, MAMMAL.Neocortex, ds, properties_from_graph=URIRef(str(DOG._NS)),
                                         comment=RDFS.comment)

    assert mammal_neocortex_comment in dog_neocortex.comment
    assert dog_neocortex_comment in dog_neocortex.comment
    assert (cat_neocortex_comment, CAT._NS) in dog_neocortex.additional_properties.get(RDFS.comment)
