...
import ckanext.digitraffic_core.actions.digitraffic_user_info as dui_actions
import ckanext.digitraffic_core.actions.package as package_actions
import ckanext.digitraffic_core.actions.organization as organization_actions
import ckanext.digitraffic_core.actions.group as group_actions
import ckanext.digitraffic_core.actions.user as user_actions
import ckanext.digitraffic_core.auth.user as user_auth
from ckanext.digitraffic_core.validators.dataset_validators import (
    value_to_list,
...
from ckanext.digitraffic_core.validators.common_validators import (
    url_error_message_formatting,
)
from ckanext.digitraffic_core.validators.resource_validators import (
    set_format_iri,
...
from ckanext.digitraffic_core.profiles.metadata_middleware import add_encoding_middleware, add_url_validity_check_middleware
from ckanext.digitraffic_core.helpers.helpers import helpers
from ckanext.digitraffic_core.search.search import before_dataset_index

from flask import Blueprint

from ckanext.digitraffic_core.views.digitraffic_edit_view import DigitrafficEditView
from ckanext.digitraffic_core.views.removed_view import RemovedView


class DigitrafficCorePlugin(plugins.SingletonPlugin, DefaultTranslation):
    """Digitraffic core plugin."""
    ...
    def update_config(self, config):
        ...
        # (relative to this plugin.py file), and 'digitraffic_core' is the name
        # that we'll use to refer to this assets directory from CKAN
        # templates.
        toolkit.add_resource("assets", "digitraffic_core")
