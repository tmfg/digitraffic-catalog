...
- Bundles all Sass files from the different sources in the `digitraffic_core.scss` file
...
To install ckanext-digitraffic_core:
...
2. Clone the source and install it on the virtualenv
    ...
    git clone https://github.com//ckanext-digitraffic_core.git
    cd ckanext-digitraffic_core
    pip install -e .
	pip install -r requirements.txt

3. Add `digitraffic_core` to the `ckan.plugins` setting in your CKAN
