 ...
 */const Ia="important",Wa=" !"+Ia,qa=(t=>(...i)=>({_$litDirective$:t,values:i}))(class extends Va{constructor(t){var i;if(super(t),t.type!==ja||"style"!==t.name||(null===(i=t.strings)||void 0===i?void 0:i.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((i,e)=>{const a=t[e];return null==a?i:i+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(t,[i]){const{style:e}=t.element;if(void 0===this.ht){this.ht=new Set;for(const t in i)this.ht.add(t);return this.render(i)}this.ht.forEach((t=>{null==i[t]&&(this.ht.delete(t),t.includes("-")?e.removeProperty(t):e[t]="")}));for(const t in i){const a=i[t];if(null!=a){this.ht.add(t);const i="string"==typeof a&&a.endsWith(Wa);t.includes("-")||i?e.setProperty(t,i?a.slice(0,-11):a,i?Ia:""):e[t]=a}}return Z}});var Fa,Ka,Ja=function(t,i,e,a){var o,s=arguments.length,r=s<3?i:null===a?a=Object.getOwnPropertyDescriptor(i,e):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,i,e,a);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(r=(s<3?o(r):s>3?o(i,e,r):o(i,e))||r);return s>3&&r&&Object.defineProperty(i,e,r),r};!function(t){t.primary="primary",t.secondary="secondary"}(Fa||(Fa={})),function(t){t.left="left",t.right="right"}(Ka||(Ka={}));class Za extends mt{constructor(){super(...arguments),this.variant=Fa.primary,this.items=[],this.verticalMenuNavText="",this.verticalMenuThreshold=768,this._open=!1}connectedCallback(){super.connectedCallback(),m(this.shadowRoot,[Za.cssVariables,Oa,Za.collapsedNavigationStyles,this.desktopStyles()])}render(){const t=this.items.filter((t=>t.position===Ka.right)),i=this.items.filter((t=>t.position!==Ka.right));return J` <div class="navigation-wrapper">
    ...
    </div>`}renderNavigationButton(){let t;switch(this.variant){case Fa.primary:t=this._open?J`<fds-icon icon="chevron-up"></fds-icon>`:J`<fds-icon icon="chevron-down"></fds-icon>`;break;case Fa.secondary:t=J`<fds-icon icon="menu"></fds-icon>`}return J`
      <button
    ...
    `}handleNavigationClick(){this._open=!this._open}renderItem(t,i=""){var e;const a=null!==(e=t.verticalMenuOrder)&&void 0!==e?e:0;return J` <li
      @click=${()=>this.handleSelect(t)}
      class="item ${this.selected===t?"item--active":""} ${i}"
      style=${qa({order:a})}
    >
      <div class="item__label">
        ${t.icon&&J`<fds-icon class="item__icon" .icon="${t.icon}"></fds-icon>`}
        <span>${t.label}</span>
      </div>
      ...
      @container navigation-wrapper (min-width: ${c(this.verticalMenuThreshold)}px) {
        ...
        .navigation--primary .item--active:after {
          ...
          border-bottom: var(--element-vertical-padding--primary) solid ${Na};
        }
  ...
  `,Za.collapsedNavigationStyles=y`
    .navigation-wrapper {
    ...
    .navigation--primary .navigation__open .item--active .item__label:after {
      ...
      border-right: var(--element-vertical-padding--primary) solid ${Na};
    }
