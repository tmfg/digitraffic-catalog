...
/**
     ...
     * See the LICENSE file in the root directory of this source tree.
     */
const Lo={xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":2,"stroke-linecap":"round","stroke-linejoin":"round"},Ro=([t,i,e])=>{const a=document.createElementNS("http://www.w3.org/2000/svg",t);return Object.keys(i).forEach((t=>{a.setAttribute(t,String(i[t]))})),e?.length&&e.forEach((t=>{const i=Ro(t);a.appendChild(i)})),a},No=t=>"string"==typeof t?t:t&&t.class?t.class&&"string"==typeof t.class?t.class.split(" "):t.class&&Array.isArray(t.class)?t.class:"":"",Oo=(t,{nameAttr:i,icons:e,attrs:a})=>{const o=t.getAttribute(i);if(null==o)return;const s=e[o.replace(/(\w)(\w*)(_|-|\s*)/g,((t,i,e)=>i.toUpperCase()+e.toLowerCase()))];if(!s)return console.warn(`${t.outerHTML} icon name was not found in the provided icons object.`);const n=(t=>Array.from(t.attributes).reduce(((t,i)=>(t[i.name]=i.value,t)),{}))(t),r={...Lo,"data-lucide":o,...a,...n},l=["lucide",`lucide-${o}`,n,a].flatMap(No).map((t=>t.trim())).filter(Boolean).filter(((t,i,e)=>e.indexOf(t)===i)).join(" ");l&&Object.assign(r,{class:l});const d=((t,i={})=>{const e={...Lo,...i};return Ro(["svg",e,t])})(s,r);return t.parentNode?.replaceChild(d,t)},Uo=[["path",{d:"m6 9 6 6 6-6"}]],Do=[["path",{d:"m18 15-6-6-6 6"}]],Ho=[["path",{d:"M15 3h6v6"}],["path",{d:"M10 14 21 3"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"}]],Bo=[["path",{d:"M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"}]],Io=[["circle",{cx:"12",cy:"12",r:"10"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"}],["path",{d:"M2 12h20"}]],Vo=[["rect",{width:"20",height:"20",x:"2",y:"2",rx:"5",ry:"5"}],["path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"}],["line",{x1:"17.5",x2:"17.51",y1:"6.5",y2:"6.5"}]],Ko=[["path",{d:"M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"}],["rect",{width:"4",height:"12",x:"2",y:"9"}],["circle",{cx:"4",cy:"4",r:"2"}]],Wo=[["line",{x1:"4",x2:"20",y1:"12",y2:"12"}],["line",{x1:"4",x2:"20",y1:"6",y2:"6"}],["line",{x1:"4",x2:"20",y1:"18",y2:"18"}]],Fo=[["path",{d:"M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"}]],Yo=[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"}],["circle",{cx:"12",cy:"7",r:"4"}]],Zo=[["path",{d:"M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17"}],["path",{d:"m10 15 5-3-5-3z"}]];
/**
     * @license lucide v0.477.0 - ISC
     *
     * This source code is licensed under the ISC license.
     * See the LICENSE file in the root directory of this source tree.
     */jQuery((function(){$(".js-disabled").removeClass("js-disabled"),(({icons:t={},nameAttr:i="data-lucide",attrs:e={}}={})=>{if(!Object.values(t).length)throw new Error("Please provide an icons object.\nIf you want to use all the icons you can import it like:\n `import { createIcons, icons } from 'lucide';\nlucide.createIcons({icons});`");if("undefined"==typeof document)throw new Error("`createIcons()` only works in a browser environment.");const a=document.querySelectorAll(`[${i}]`);if(Array.from(a).forEach((a=>Oo(a,{nameAttr:i,icons:t,attrs:e}))),"data-lucide"===i){const i=document.querySelectorAll("[icon-name]");i.length>0&&(console.warn("[Lucide] Some icons were found with the now deprecated icon-name attribute. These will still be replaced for backwards compatibility, but will no longer be supported in v1.0 and you should switch to data-lucide"),Array.from(i).forEach((i=>Oo(i,{nameAttr:"icon-name",icons:t,attrs:e}))))}})({icons:{ExternalLink:Ho,User:Yo,Menu:Wo,Globe:Io,ChevronDown:Uo,ChevronUp:Do,Facebook:Bo,Twitter:Fo,Instagram:Vo,Youtube:Zo,Linkedin:Ko}})}))}();
