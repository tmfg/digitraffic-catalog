 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ja=1;let Va=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,i,e){this._$Ct=t,this._$AM=i,this._$Ci=e}_$AS(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}};
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ia="important",Fa=" !"+Ia,Ka=(t=>(...i)=>({_$litDirective$:t,values:i}))(class extends Va{constructor(t){var i;if(super(t),t.type!==ja||"style"!==t.name||(null===(i=t.strings)||void 0===i?void 0:i.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((i,e)=>{const a=t[e];return null==a?i:i+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`}),"")}update(t,[i]){const{style:e}=t.element;if(void 0===this.ht){this.ht=new Set;for(const t in i)this.ht.add(t);return this.render(i)}this.ht.forEach((t=>{null==i[t]&&(this.ht.delete(t),t.includes("-")?e.removeProperty(t):e[t]="")}));for(const t in i){const a=i[t];if(null!=a){this.ht.add(t);const i="string"==typeof a&&a.endsWith(Fa);t.includes("-")||i?e.setProperty(t,i?a.slice(0,-11):a,i?Ia:""):e[t]=a}}return G}});var Wa,qa,Za=function(t,i,e,a){var o,s=arguments.length,r=s<3?i:null===a?a=Object.getOwnPropertyDescriptor(i,e):a;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,i,e,a);else for(var n=t.length-1;n>=0;n--)(o=t[n])&&(r=(s<3?o(r):s>3?o(i,e,r):o(i,e))||r);return s>3&&r&&Object.defineProperty(i,e,r),r};!function(t){t.primary="primary",t.secondary="secondary"}(Wa||(Wa={})),function(t){t.left="left",t.right="right"}(qa||(qa={}));class Ga extends gt{constructor(){super(...arguments),this.variant=Wa.primary,this.items=[],this.verticalMenuNavText="",this.verticalMenuThreshold=768,this._open=!1}connectedCallback(){super.connectedCallback(),g(this.shadowRoot,[Ga.cssVariables,Oa,Ga.collapsedNavigationStyles,this.desktopStyles()])}render(){const t=this.items.filter((t=>t.position===qa.right)),i=this.items.filter((t=>t.position!==qa.right));return Z` <div class="navigation-wrapper">
      <div class="navigation navigation--${this.variant} ui-label-text">
        ${this.variant===Wa.primary?Z` <div class="navigation__header">
              <slot></slot>
            </div>`:J}
    ...
    </div>`}renderNavigationButton(){let t;switch(this.variant){case Wa.primary:t=this._open?Z`<fds-icon icon="chevron-up"></fds-icon>`:Z`<fds-icon icon="chevron-down"></fds-icon>`;break;case Wa.secondary:t=Z`<fds-icon icon="menu"></fds-icon>`}return Z`
      <button
  ...
  `,Ga.collapsedNavigationStyles=y`
    .navigation-wrapper {
