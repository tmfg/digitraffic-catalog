...
class MobilityDCATAPProfile(RDFProfile):
    ...
    def graph_from_dataset(self, dataset_dict, dataset_ref):
        ...
        self.add_vocabulary(g, dataset_ref, MOBILITYDCATAP.mobilityTheme, mobility_data.mobility_theme_sub)
        self.add_vocabulary(g, dataset_ref, DCTERMS.spatial, mobility_data.spatial)
        ...
        for dist in mobility_data.distribution:
            self.add_class_instance(g, dataset_ref, DCAT.distribution, dist)
