...
class TestFluentHelpers(object):
    ...
    def test_fluent_form_label_not_exists(self):
        ...
        field = {
            "fluent_form_label": {"en": "English label", "fr": "French label"},
