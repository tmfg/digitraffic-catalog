...
class FluentPlugin(p.SingletonPlugin):
    ...
    def get_validators(self):
        return {
            ...
            "fluent_text_output": validators.fluent_text_output,
            "fluent_tags": validators.fluent_tags,
            "fluent_tags_output": validators.fluent_tags_output,
            "fluent_core_translated_output": validators.fluent_core_translated_output,
        }
